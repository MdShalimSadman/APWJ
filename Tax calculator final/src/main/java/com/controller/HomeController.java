 ...
 */
    ...
    public String homepage(@ModelAttribute("username") String username,Model model){
    ...
    public String showtax(Model model){
        ...
        model.addAttribute("username", h.getUsername());

        return "history";
    }

    @RequestMapping("/taxcalculate")
    public String calculate(@Valid @ModelAttribute("Basic_salary") int Basic_salary,@ModelAttribute("username") String username, @ModelAttribute("House_rent") int House_rent, @ModelAttribute("Medical_allowance") int Medical_allowance,@ModelAttribute("Conveyance") int Conveyance,@ModelAttribute("Incentive") int Incentive,@ModelAttribute("Festival_Bonus") int Festival_Bonus,@ModelAttribute("Investment_amount") int Investment_amount, @ModelAttribute("Category") String Category, Model model) throws SQLException {
